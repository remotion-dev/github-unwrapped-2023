...
export const UFO_WIDTH = 320;
export const UFO_HEIGHT = 176;
...
export const Ufo = (
  ...
  const actualUfoWidth = UFO_WIDTH * props.scale;
  const actualUfoHeight = UFO_HEIGHT * props.scale;
