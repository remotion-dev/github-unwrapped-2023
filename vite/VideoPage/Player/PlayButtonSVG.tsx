export const PlayButtonSVG: React.FC<{ isHovering: boolean }> = ({
  isHovering,
}) => {
  const defaultSVG = (
    <svg
    ...
    >
      ...
      <g filter="url(#filter1_d_1294_1209)">
        ...
        <path
          d="M102.008 46.5463C102.008 45.6931 102.7 44.9994 103.553 45.0226C114.286 45.3153 124.73 48.6346 133.674 54.6129C143.046 60.8776 150.351 69.781 154.663 80.1971C158.976 90.6132 160.103 102.074 157.901 113.131C155.7 124.187 150.27 134.343 142.297 142.313C134.324 150.283 124.167 155.711 113.109 157.908C102.052 160.106 90.5916 158.975 80.1769 154.659C69.7622 150.343 60.8612 143.036 54.5995 133.661C48.6242 124.715 45.3083 114.27 45.0192 103.537C44.9962 102.684 45.6902 101.992 46.5434 101.992V101.992C47.3966 101.992 48.0858 102.684 48.1101 103.537C48.3985 113.659 51.5329 123.507 57.1688 131.945C63.0911 140.811 71.5096 147.723 81.3597 151.805C91.2099 155.887 102.049 156.956 112.507 154.878C122.965 152.799 132.572 147.666 140.113 140.128C147.653 132.59 152.789 122.985 154.871 112.528C156.953 102.07 155.887 91.2305 151.809 81.379C147.73 71.5275 140.821 63.1067 131.957 57.1816C123.521 51.5429 113.674 48.4053 103.552 48.1135C102.699 48.089 102.007 47.3995 102.008 46.5463V46.5463Z"
          fill="#6D708C"
          stroke="#6D708C"
          strokeWidth="2.09174"
          mask="url(#path-5-inside-1_1294_1209)"
        />
        <path
  ...
  const hoverSVG = (
    ...
    >
      ...
      <g filter="url(#filter2_d_1294_1240)">
        ...
        <path
          d="M87.7795 78.6583C86.1849 77.7016 84.1562 78.8502 84.1562 80.7098V124.294C84.1562 126.153 86.1849 127.302 87.7795 126.345L124.099 104.553C125.648 103.624 125.648 101.38 124.099 100.45L87.7795 78.6583Z"
          fill="white"
        />
        <mask id="path-8-inside-1_1294_1240" fill="white">
          <path d="M102.008 47.5463C102.008 46.6931 102.7 45.9994 103.553 46.0226C114.286 46.3153 124.73 49.6346 133.674 55.6129C143.046 61.8776 150.351 70.781 154.663 81.1971C158.976 91.6132 160.103 103.074 157.901 114.131C155.7 125.187 150.27 135.343 142.297 143.313C134.324 151.283 124.167 156.711 113.109 158.908C102.052 161.106 90.5916 159.975 80.1769 155.659C69.7622 151.343 60.8612 144.036 54.5995 134.661C48.6242 125.715 45.3083 115.27 45.0192 104.537C44.9962 103.684 45.6902 102.992 46.5434 102.992C47.3966 102.992 48.0858 103.684 48.1101 104.537C48.3985 114.659 51.5329 124.507 57.1688 132.945C63.0911 141.811 71.5096 148.723 81.3597 152.805C91.2099 156.887 102.049 157.956 112.507 155.878C122.965 153.799 132.572 148.666 140.113 141.128C147.653 133.59 152.789 123.985 154.871 113.528C156.953 103.07 155.887 92.2305 151.809 82.379C147.73 72.5275 140.821 64.1067 131.957 58.1816C123.521 52.5429 113.674 49.4053 103.552 49.1135C102.699 49.089 102.007 48.3995 102.008 47.5463Z" />
        </mask>
        <path
          d="M102.008 47.5463C102.008 46.6931 102.7 45.9994 103.553 46.0226C114.286 46.3153 124.73 49.6346 133.674 55.6129C143.046 61.8776 150.351 70.781 154.663 81.1971C158.976 91.6132 160.103 103.074 157.901 114.131C155.7 125.187 150.27 135.343 142.297 143.313C134.324 151.283 124.167 156.711 113.109 158.908C102.052 161.106 90.5916 159.975 80.1769 155.659C69.7622 151.343 60.8612 144.036 54.5995 134.661C48.6242 125.715 45.3083 115.27 45.0192 104.537C44.9962 103.684 45.6902 102.992 46.5434 102.992C47.3966 102.992 48.0858 103.684 48.1101 104.537C48.3985 114.659 51.5329 124.507 57.1688 132.945C63.0911 141.811 71.5096 148.723 81.3597 152.805C91.2099 156.887 102.049 157.956 112.507 155.878C122.965 153.799 132.572 148.666 140.113 141.128C147.653 133.59 152.789 123.985 154.871 113.528C156.953 103.07 155.887 92.2305 151.809 82.379C147.73 72.5275 140.821 64.1067 131.957 58.1816C123.521 52.5429 113.674 49.4053 103.552 49.1135C102.699 49.089 102.007 48.3995 102.008 47.5463Z"
          fill="#6D708C"
          stroke="#6D708C"
          strokeWidth="2.09174"
          mask="url(#path-8-inside-1_1294_1240)"
        />
      </g>
      <defs>
        <filter
